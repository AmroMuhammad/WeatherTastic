...
public class SunriseSunsetView extends View {
    ...
    private SimpleSunriseSunsetLabelFormatter mLabelFormatter = new SimpleSunriseSunsetLabelFormatter();
    ...
    public SimpleSunriseSunsetLabelFormatter getLabelFormatter() {
        return mLabelFormatter;
    }

    public void setLabelFormatter(SimpleSunriseSunsetLabelFormatter labelFormatter) {
    ...
    public void startAnimate(Calendar car) {
        if (mSunriseTime == null || mSunsetTime == null) {
